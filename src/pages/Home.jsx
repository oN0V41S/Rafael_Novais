    ...
    return (
        <main>
            ...
            <section className='about'>
                ...
                <p>Meu nome é Rafael tenho 17 anos, sou apaixonado por programação desde os 14 anos, sou Desenvolvedor de Sistemas, atualmente tenho conhecimento em Front-End, com foco em ReactJS, mas estou estudando novas habilidades em Back-End para me Tornar um Desenvolvedor FullSatck.</p>
            </section>
